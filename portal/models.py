...
class Order(TimeStampedModel):
	...
	outer_page_quality = models.ForeignKey(PageQuality, related_name='outer_page_quality')
	inner_page_quality = models.ForeignKey(PageQuality, related_name='inner_page_quality')
	binding_type = models.ForeignKey(BindingType)
