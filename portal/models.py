...
class Order(TimeStampedModel):
	...
	work_type = models.ForeignKey(WorkType)
	size = models.ForeignKey(WorkSubType, null=True, related_name='order_size')
	photo_size = models.ForeignKey(WorkSubType, null=True, related_name='order_photo_size')
